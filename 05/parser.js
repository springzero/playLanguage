...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.parseStatement = function () {
        var t = this.scanner.peek();
        if (t.kind == scanner_1.TokenKind.Keyword && t.code == scanner_1.Keyword.Function) {
            return this.parseFunctionDecl();
        }
        else if (t.kind == scanner_1.TokenKind.Keyword && t.code == scanner_1.Keyword.Return) {
    ...
    Parser.prototype.parseVariableDecl = function () {
        ...
        if (t.kind == scanner_1.TokenKind.Identifier) {
            ...
            if (t1.text == ':') {
                ...
                if (t2.kind == scanner_1.TokenKind.Identifier || t2.kind == scanner_1.TokenKind.Keyword) {
                    this.scanner.next();
                    varType = t2.text;
                }
                else {
    ...
    Parser.prototype.parseFunctionCall = function () {
        ...
        if (t1.text == '(') {
            t1 = this.scanner.peek();
            while (t1.text != ')' && t1.kind != scanner_1.TokenKind.EOF) {
