...
import { AstVisitor, AstNode, Block, Prog, VariableDecl, FunctionDecl, FunctionCall, Statement, Expression, ExpressionStatement, Binary, IntegerLiteral, DecimalLiteral, StringLiteral, Variable, ReturnStatement, IfStatement, ForStatement, Unary, AstDumper } from './ast';
...
class Intepretor extends AstVisitor {
    ...
    visitVariableDecl(variableDecl: VariableDecl) {
        if (variableDecl.init != null) {
            ...
            // if (this.isLeftValue(v)) {  // 新版05的代码 没有这个分支了 逻辑放到了visitVariable里
    ...
    private getVariableValue(sym: VarSymbol) {
