...
var Scope = /** @class */ (function () {
    function Scope(enclosingScope, debugName) {
        // 存储
...
var ScopeDumper = /** @class */ (function (_super) {
    ...
    ScopeDumper.prototype.visitForStatement = function (stmt, prefix) {
        ...
        _super.prototype.visitForStatement.call(this, stmt, prefix);
    };
    // 作用域 ——> 找到符号 -> 调用各符号自身方法accept()
    ScopeDumper.prototype.dumpScope = function (scope, prefix) {
        var e_1, _a;
        var _b;
        console.log(prefix + "    father: " + ((_b = scope.enclosingScope) === null || _b === void 0 ? void 0 : _b.debugName));
        if (scope.name2symbol.size > 0) {
            // 遍历该作用域的符号
            var symbolDumper = new symbol_1.SymbolDumper();
            try {
                for (var _c = __values(scope.name2symbol.values()), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var s = _d.value;
