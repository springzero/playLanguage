import { Binary, Block, CallSignature, DecimalLiteral, ErrorExp, ErrorStmt, Expression, ExpressionStatement, ForStatement, FunctionCall, FunctionDecl, IfStatement, IntegerLiteral, ParameterList, Prog, ReturnStatement, Statement, StringLiteral, Unary, Variable, VariableDecl, VariableStatement } from "./ast";
...
export class Parser {
    ...
    parseForStatement():ForStatement{
        ...
        if(t.code == Seperator.OpenParen) { // '('
         ...
         return new ForStatement(beginPos, this.scanner.getLastPos(), init, condition, increment, stmt, isErrorNode);
    }
